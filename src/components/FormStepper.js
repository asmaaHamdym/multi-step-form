    ...
    <div className='form-stepper'>
      ...
      <div className="form_stepper__body">
        ...
        <div className="input-group">
          ...
          <input type='text'  required name='education' onChange={handleInputChange}/>
      ...
      <div className='form-stepper__action'>
        { step>1 && <button className='btn btn-back' onClick={() => onStepChange(step -1)}>Back</button>}
        
        <button className='btn btn-next' onClick={() => onStepChange(step+1)}>Next</button>
