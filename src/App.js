    ...
    <div className="App">
      <div className="wrapper">
        ...
        <div className="onboarding_left_image">
          <img src="https://cdn.pixabay.com/photo/2023/07/19/03/23/girl-8135986_640.png"
      ...
      <div className="onboarding_right">
          ...
          step===0 && (
            <div className='first-step'>
              ...
              <div className="first-step-buttons">
                ...
                <button className='btn btn-primary' onClick={ () => handleStep(1)}>Sign up with Email</button>
        ...
        {
          /**if the stepper is higheer than 0, render the stepper */
